    ...
    def SPFA(self, graph, Q):
        ...
        while not que.empty():
            ...
            for v in graph[u]:
                ...
                if distG[u] + 1 + self.factor * (maxTruss - tmpminTruss) < distTruss[v]:
                    distTruss[v] = distG[u] + 1 + self.factor * (maxTruss - tmpminTruss)
                    distG[v] = distG[u] + 1
